...
/** Default factory: opens a better-sqlite3 connection at the given path, or falls back to node:sqlite. */
function betterSqliteFactory(resolvedPath: string): Db {
  try {
    ...
    try {
      ...
      throw new Error(
        'Neither better-sqlite3 nor node:sqlite is available. Please reinstall dependencies or use Node.js 22.13+.',
        { cause },
      );
    }
  }
